...
function showdivsettingbutton(counterclics){
	if (counterclics%2!=0){
		document.getElementById("div_parametersform").style.display = "block"; //show settings form
	}
	else{
		document.getElementById("div_parametersform").style.display = "none"; //don't show settings form
	}
 ...
 var eztravelheight;//new
  ...
  var actual_ext=0;
    for (var layer_counter=1; layer_counter <= numlayers; layer_counter = layer_counter+1){
		...
		gcode=gcode+";Moving to the layer number "+(layer_counter)+" No z travel height between layers"+"\n";
		gcode=gcode+"G1 Z"+actual_z+" F"+feedrate+"\n";		
...
/*
*This function is to create the string called orderedpoints this function is not used in this App
*/
	...
	processing.draw = function() {							
		...
		*/
		function canvasframe1() {
			...
			document.getElementById("div_dateform").style.display = "block"; //show birthday form
			document.getElementById("div_buttons").style.display = "none"; //don't show button save gcode
			document.getElementById("div_textarea").style.display = "none"; //don't show textarea
			document.getElementById("div_parametersform").style.display = "none"; //don't show settings form*/	
			...
			processing.background(248,248,250);
			processing.image (buttonclickhere, sizescreenx/2-90, 50); 
		...
		*/
		function canvasframe2(day,month,year) {
			...
			processing.stroke(61,116,137);   // stroke color RGB 
			switch(n_selected1) {
				case 1: /*RECTANGLE*/
					numpoints1=4;
			...
			if (numbers[2]%2!=0 & numbers[3]%2==0){
				...
				/*End of Selection of shape 2 (inside)*/
			...
			processing.noFill(); // no fill shapes
			processing.strokeWeight(3);  // Thicker
			processing.stroke(128,184,206);   // stroke color RGB 
			switch(n_selected2) {
				case 1: /*RECTANGLE*/
					numpoints2=4;
